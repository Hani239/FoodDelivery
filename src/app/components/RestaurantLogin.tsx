...
const RestaurantLogin = (props: Props) => {
  ...
  const handleLogin=async ()=>{
    ...
    if(response.success){
      ...
      localStorage.setItem("restaurantUser",JSON.stringify(result));  //i have share this restaurantUser id to AddFoodItem to localstorage in api call
